// Package main is the User Service entry point. It loads configuration,
...
func main() {
	...
	logger.Default().Info("user-service starting",
	...
	waitForShutdown()
	logger.Default().Info("user-service shutting down")
	_ = h.Close()
}
