// Package main is the Knowledge Service entry point. It loads configuration,
...
func main() {
	...
	logger.Default().Info("knowledge-service starting",
	...
	waitForShutdown()
	logger.Default().Info("knowledge-service shutting down")
	_ = h.Close()
}
