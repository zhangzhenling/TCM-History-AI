...
func TestTxFrom_DefaultsToBaseDB(t *testing.T) {
	...
	require.NoError(t, got.Create(&entity.Conversation{
...
func TestWithTx_StampsContext(t *testing.T) {
	...
	err := db.Transaction(func(tx *gorm.DB) error {
		...
		db.Model(&entity.Conversation{}).Count(&outsideCount)
	...
	db.Model(&entity.Conversation{}).Count(&committedCount)
